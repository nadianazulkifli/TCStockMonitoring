            ...
            <div class="page-box mt-4">
                <div class="section-head">
                    <div>
                        ...
                        <p class="section-desc">Direct access to key modules</p>
                    </div>
                    ...
                    <div class="quick-actions">
                        ...
                        <a href="<%= request.getContextPath() %>/alerts" class="btn btn-primary">Alerts</a>
                        <a href="<%= request.getContextPath() %>/reports" class="btn btn-dark">Reports</a>
                    </div>
                </div>
            </div>
