...
<%
    ...
    if (role == null || !"worker".equalsIgnoreCase(role)) {
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="stat-card stat-red">
                        ...
                        <p class="stat-note">Visible inventory records</p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="stat-card stat-gold">
                        ...
                        <p class="stat-note">Need attention</p>
                    </div>
                </div>
            ...
            <div class="page-box mt-4">
                <div class="section-head">
                    <div>
                        ...
                        <p class="section-desc">Main actions for daily stock work</p>
                    </div>

                    <div class="quick-actions">
                        <a href="<%= request.getContextPath() %>/stock?action=in" class="btn btn-primary">Stock In</a>
                        <a href="<%= request.getContextPath() %>/stock?action=out" class="btn btn-dark">Stock Out</a>
                        <a href="<%= request.getContextPath() %>/stock-count" class="btn btn-primary">Stock Count</a>
                        <a href="<%= request.getContextPath() %>/alerts" class="btn btn-dark">Alerts</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="section-head">
                        <div>
                            ...
                            <p class="section-desc">Items that may need refill soon</p>
                        </div>
                    </div>
